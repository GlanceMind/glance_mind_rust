-- Revert foreign key constraint back to gm_ai_video_models
...
-- Step 2: Restore the old foreign key constraint to gm_ai_video_models
ALTER TABLE gm_video_generation_tasks
  ADD CONSTRAINT gm_video_generation_tasks_model_id_fkey 
  FOREIGN KEY (model_id) REFERENCES gm_ai_video_models(id);
