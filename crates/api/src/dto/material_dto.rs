...
pub struct CreateMaterialRequest {
    ...
    pub video_url: String, // URL from OSS upload
    #[validate(length(min = 1, message = "Tag is required"))]
    pub tag: String, // Single tag, selected from predefined tags (required)
    #[validate(length(min = 1, message = "Title is required"))]
    pub title: String, // Material name/title (required)
    pub description: Option<String>, // Optional description
    // Note: prompt is not required from user, will be auto-generated by AI video analysis
}
