...
// protocol_gen module deleted in v2 cutover Phase 2.2 — types now live in
// the canonical glance_mind_protocol crate (Cargo path-dep above) and are
// auto-generated by prost from glance_mind_protocol/proto/*.proto.
// Use `glance_mind_protocol::glance_mind::*` for typed access.
pub mod repository;
pub mod response;
pub mod routes;
pub mod service;
