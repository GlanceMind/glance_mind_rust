...
impl ToolRegistry {
    ...
    pub fn definitions() -> Vec<ToolDefinition> {
        vec![
            ...
            // ── Mutation tools ──────────────────────────────────
            Self::def("create_social_account", "创建社交媒体账户", SafetyLevel::Create, json!({ "type": "object", "properties": { "platform_id": { "type": "integer", "description": "平台ID" }, "username": { "type": "string", "description": "账户用户名" }, "device_id": { "type": "string", "description": "设备ID" } }, "required": ["platform_id", "username"] })),
