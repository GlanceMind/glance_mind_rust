...
impl ToolRegistry {
    pub fn definitions() -> Vec<ToolDefinition> {
        vec![
            ...
            Self::def("create_campaign", "创建营销活动", SafetyLevel::Create, json!({ "type": "object", "properties": { "name": { "type": "string" }, "platform_id": { "type": "integer" }, "region_id": { "type": "integer" }, "ai_model_id": { "type": "integer" }, "social_group_id": { "type": "integer" }, "keywords": { "type": "string" }, "budget_cap": { "type": "number" } }, "required": ["name", "platform_id"] })),
    ...
    pub async fn execute(
        ...
        let result: Value = match tool_name {
            ...
            "create_campaign" => {
                let dto: crate::dto::campaign_dto::CampaignCreateDto = serde_json::from_value(params.clone())
